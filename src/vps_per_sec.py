...
def table_disr(
    ...
    H1, xedges1, yedges1 = np.histogram2d(X[jj_50], Y[jj_50], bins=25, range=[X_range, Y_range])
    # denminator
...
ans = input(
    "Do you have all 3 tables for CMod and TCV? (--> 'no', 'yes) If 'no', then restart the program"
    " with inputs for missing data\n"
)
